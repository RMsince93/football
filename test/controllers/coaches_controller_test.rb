...
class CoachesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coach" do
    assert_difference("Coach.count") do
      post coaches_url, params: { coach: { age: @coach.age, country_id: @coach.country_id, name: @coach.name } }
    end
  ...
  test "should update coach" do
    patch coach_url(@coach), params: { coach: { age: @coach.age, country_id: @coach.country_id, name: @coach.name } }
